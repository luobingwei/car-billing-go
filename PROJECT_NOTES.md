...
- **GitHub 仓库**：`https://github.com/luobingwei/car-billing-go`（首版 v1.0.0）
- **本机代码目录**：`/home/user/Doubao/chats/38421063805886978/car-billing/`
- **交付包**：`car-billing-go-v2.zip`（在代码目录上级，实为 v1.0.0 内容）

## 二、功能清单（v1.0.0 全部已实现并验证）
...
### 数据文件
- `data/firms.json`：费率数据（两家示例公司：雷亚尔胜利屋协议价800、非协议价1000）
- `data/orders.db`：订单库（首次运行自动生成）
...
- 用户当前动作：把本版作为 v1.0.0 首版，清空 GitHub 旧仓库重新上传
